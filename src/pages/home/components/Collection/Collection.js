...
export const Collection = ({
  items, onCartAdd, cartData, onImageLoaded, onImageError,
}) => {
            ...
            {items.map(({
              ...
              <div className="collectionProductCard" key={key}>
                <div className="collectionImageContainer">
                  <Image className="collectionImage" src={image} alt="imageCard" onImageLoaded={onImageLoaded} onError={onImageError} />
                </div>
